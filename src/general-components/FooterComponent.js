    ...
    <div className='module-container'>
      <div className='row no-gutters align-items-top py-4'>
        ...
        <div className='col-md-5 offset-md-1'>
          <p>
            Site created by <a href='http://alex.holachek.com' target='_blank'>Alex Holachek <span className='sr-only'> opens in new window</span></a>.
          </p>

          <p>
            Supplemental legislator information sourced from the <a href='http://docs.openstates.org/en/latest/api/' target='_blank'>Open States API <span className='sr-only'> opens in new window</span></a>.
          </p>
        </div>
      </div>
